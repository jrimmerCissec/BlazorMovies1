...
{
    public static class IHttpServiceEtensionMethods 
    {
        ...
        public static async Task<PaginatedResponse<T>> GetHelper<T>(this IHttpService httpService, string url, PaginationDTO paginationDTO)
        {
            ...
            paginatedResponse.Response = httpResponse.Response;
            paginatedResponse.TotalAmountOfPages = totalAmountOfPages;
